  ...
  return (
    <div className="outer container flex md:flex-row flex-col ">
      <div className="topContainer justify-center items-center">
        ...
        <div className="addedby text-center text-xl">
          Added By: {location.addedByUserId}
        </div>
        <div className="maintext text-center md:text-xl flex-wrap md:m-10 m-6">
        ...
        <div className="flex flex-row md:m-5 ml-10 text-center md:justify-center w-1/2">
          <div className="lat md:text-xl text-center m-2">
            Latitude: {location.lat}
          </div>
          <div className="Long md:text-xl text-center m-2">
            Longitude: {location.lng}
          </div>
        </div>

        <div className=" md:p-3 bg-green-600 rounded-lg text-white md:text-3xl text-2xl md:hover:text-gray-700 hover:bg-green-500 text-center md:m-7 m-4 md:w-1/4 w-full r">
          <Link href={`/locations`}>See All Sites</Link>
        </div>
      </div>
    </div>
  )
